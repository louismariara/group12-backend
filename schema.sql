...
--
-- Name: instructor instructor_course_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.instructor
    ADD CONSTRAINT instructor_course_id_key UNIQUE (course_id);
...
ALTER TABLE ONLY public.grade
    ADD CONSTRAINT grade_course_id_fkey FOREIGN KEY (course_id) REFERENCES public.course(id);
...
ALTER TABLE ONLY public.instructor
    ADD CONSTRAINT instructor_course_id_fkey FOREIGN KEY (course_id) REFERENCES public.course(id);
...
GRANT ALL ON TABLE public.student_course TO anon;
GRANT ALL ON TABLE public.student_course TO authenticated;
GRANT ALL ON TABLE public.student_course TO service_role;
