...
class User(db.Model):
    ...
    password = db.Column(db.LargeBinary, nullable=False)  # Updated for Bcrypt
...
class Student(db.Model):
    ...
    password = db.Column(db.String(100), nullable=False)  # Can keep as String or update to LargeBinary if using Bcrypt
